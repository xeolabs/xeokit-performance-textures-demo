...
function extract(elements) {
    ...
    return {
        ...
        eachMaterialTexturesPortion: [14],
        eachMaterialAttributesPortion: [15],
        ...
        eachEntityId: elements[26],
        eachEntityMeshesPortion: elements[27],

        eachTileAABB: elements[28],
        eachTileEntitiesPortion: elements[29]
    };
}
...
function inflate(deflatedData) {
    ...
    return {
        ...
        eachTextureDataPortion: new Float32Array(inflate(deflatedData.uvs)),
        ...
        eachMaterialType: new Int8Array(inflate(deflatedData.eachMaterialType)),
...
function load(viewer, options, inflatedData, performanceModel) {
    ...
    for (let materialIndex = 0; materialIndex < numMaterials; materialIndex++) {
        ...
        const materialTexturesPortion = eachMaterialTexturesPortion[materialIndex];
        const materialAttributesPortion = eachMaterialAttributesPortion[materialIndex];
                    ...
                    if (geometryArrays) {
                        ...
                        if (geometryArrays.batchThisMesh) {
                            ...
                            performanceModel.createMesh(utils.apply(meshDefaults, {
                                ...
                                uvs: geometryArrays.geometryUVs,
